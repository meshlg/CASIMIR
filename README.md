...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/Version-1.0.2-blue" alt="Version"></a>
  <br>
...
2. Click the **Raw** button on `CASIMIR.user.js` in this repository
...
| **CSP/DOM hardening** | Uses Shadow DOM + CSP-safe stylesheets and fail-closed mount behavior |
