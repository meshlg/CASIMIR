...
// @updateURL    https://update.greasyfork.org/scripts/566920/CASIMIR.meta.js
// @downloadURL  https://update.greasyfork.org/scripts/566920/CASIMIR.user.js
// ==/UserScript==
...
(function () {
  ...
  onReady(() => {
    ...
    const shadowCss = `
      :host {
        --font: "Inter", "SF Pro Text", "Segoe UI Variable", "Segoe UI", ui-sans-serif, system-ui, sans-serif;
        ...
        --shadow: 0 16px 40px rgba(0, 0, 0, .10), 0 0 0 1px var(--stroke);
        --shadow2: 0 4px 16px rgba(0, 0, 0, .07);
        ...
        --ring: 0 0 0 2px var(--bg1), 0 0 0 4px var(--brand);
        --ringQ: 0 0 0 2px var(--bg1), 0 0 0 4px var(--quantum);
      ...
      :host(.pg-theme-dark) {
        ...
        --shadow2: 0 6px 20px rgba(0, 0, 0, .40);
      ...
      @keyframes pg-pulse-danger{ 0%,100%{ box-shadow:0 0 0 0 rgba(204,57,57,.35); } 50%{ box-shadow:0 0 0 4px rgba(204,57,57,0); } }
      @keyframes pg-glow-quantum{ 0%,100%{ border-color:var(--quantum); color:var(--quantum); opacity:1; } 50%{ border-color:var(--quantum); color:var(--quantum); opacity:.72; } }
      ...
      #pg-toggle-btn:hover{ transform:translateY(-2px); background:var(--bg2); border-color:var(--stroke2); }
      ...
      #pg-toggle-btn.quantum-active:hover{ background:var(--quantum-bg); }
      ...
      .pg-title{ margin:0; display:flex; align-items:center; gap:10px; font-size:15px; font-weight:700; letter-spacing:.2px; color:var(--text-bright); }
      ...
      .pg-close{
        ...
        background:var(--bg1); color:var(--muted); cursor:pointer; display:grid; place-items:center;
        font-size:14px; outline:none;
        transition:background .15s,border-color .15s,color .15s,transform .15s;
      }
      .pg-close:hover{ background:var(--bg2); border-color:var(--stroke2); color:var(--text); }
      ...
      #pg-toast.toast-success{ border-color:var(--success); }
      #pg-toast.toast-warn{ border-color:var(--warn); }
      #pg-toast.toast-danger{ border-color:var(--danger); }
      ...
      #pg-password-output{
        ...
        border-radius:var(--r10); border:1px solid var(--stroke); background:var(--bg2);
      ...
      /* Buttons */
      .pg-btn{
        border:1px solid var(--stroke); border-radius:var(--r10); background:var(--bg1);
      ...
      .pg-btn:hover{ background:var(--bg2); border-color:var(--stroke2); }
      ...
      .pg-btn.primary:hover{ background:color-mix(in srgb, var(--brand) 88%, black 12%); border-color:color-mix(in srgb, var(--brand) 88%, black 12%); }

      .pg-btn.primary:focus-visible{ box-shadow:var(--ring); }
      .pg-btn.primary.quantum{
        border-color:var(--quantum);
        background:var(--quantum);
        color:#fff;
      }
      .pg-btn.primary.quantum:hover{ background:color-mix(in srgb, var(--quantum) 88%, black 12%); border-color:color-mix(in srgb, var(--quantum) 88%, black 12%); }

      .pg-btn.primary.quantum:focus-visible{ box-shadow:var(--ringQ); }
      ...
      input[type="checkbox"].pg-switchInput:checked + .switch{
        background:var(--quantum-bg); border-color:var(--quantum);
      }
      ...
      input[type="range"]::-webkit-slider-thumb:hover{ transform:scale(1.1); box-shadow:0 2px 6px rgba(0,0,0,.25); }
      ...
      .pg-check:hover{ background:var(--bg2); border-color:var(--stroke2); }
      ...
      #pg-badge{
        ...
        border:1px solid var(--quantum); color:var(--quantum);
      ...
      .pg-meter-seg.lit-red{ background:var(--danger); }
      .pg-meter-seg.lit-orange{ background:var(--warn); }
      .pg-meter-seg.lit-yellow{ background:var(--warn); }
      .pg-meter-seg.lit-green{ background:var(--success); }
      .pg-meter-seg.lit-cyan{ background:var(--brand); }
      ...
      .pg-crack-time.seconds{ color:var(--danger); background:var(--danger-bg); }
      .pg-crack-time.minutes{ color:var(--warn); background:var(--warn-bg); }
      .pg-crack-time.hours{ color:var(--warn); background:var(--warn-bg); }
      ...
      .pg-crack-time.years{ color:var(--success); background:var(--success-bg); }
      .pg-crack-time.centuries{ color:var(--brand); background:var(--brand-bg); }

      .pg-crack-time.danger-pulse{ animation:pg-pulse-danger 1.5s infinite; border:1px solid var(--danger); }
      ...
      .pg-recomm-detail{ display:block; margin-top:2px; opacity:.72; font-size:11px; line-height:1.45; }
      ...
      .pg-breach-status.safe{ background:var(--success-bg); border:1px solid var(--success); color:var(--success); }
      .pg-breach-status.compromised{ background:var(--danger-bg); border:1px solid var(--danger); color:var(--danger); }
      .pg-breach-status.error{ background:var(--warn-bg); border:1px solid var(--warn); color:var(--warn); }
      ...
      .pg-test-section{
        display:flex; flex-direction:column; gap:8px;
        padding:12px; background:var(--bg2); border-radius:var(--r12);
      }
      ...
      .pg-test-btn:hover{ background:var(--bg3); }
      .pg-test-btn.primary{ background:var(--brand); border-color:var(--brand); color:#fff; }
      .pg-test-btn.primary:hover{ background:color-mix(in srgb, var(--brand) 88%, black 12%); }

      /* Footer */
      .pg-footer{
        padding:10px 16px; border-top:1px solid var(--stroke); background:var(--bg0);
      ...
      <section id="pg-panel" role="dialog" aria-label="CASIMIR password generator">
        ...
        <div class="pg-header">
          <div class="pg-titleBlock">
            ...
            <p class="pg-subtitle"><span data-i18n="subtitle">Cryptographic Authentication System In Micro Interval Randomness</span> · 1.0.2</p>
          </div>
    ...
    const TRANSLATIONS = {
      ru: {
        ...
        w_phish_d: 'Если вы введете крипт��устойчивый пароль на фейковом сайте, злоумышленники его получат.',
    ...
    function setQuantumVisuals(isEnabled) {
      ...
      if (isEnabled) {
        ...
        if (!prefersReducedMotion()) {
          badge.animate(
            [{ boxShadow: '0 0 0 0 rgba(124,92,214,.30)' }, { boxShadow: '0 0 0 8px rgba(124,92,214,0)' }],
    ...
    function getRecommendations(analysis) {
      ...
      if (analysis.entropyPenalty > 0 && analysis.baseEntropy > 0) {
        ...
        if (penaltyPercent > 30) {
          recs.push({
            type: 'warn',
            text: lang === 'ru'
              ? `Высокий штраф энтропии: -${penaltyPercent}%`
              : `High entropy penalty: -${penaltyPercent}%`,
            detail: lang === 'ru'
              ? `Базовая энтропия: ${analysis.baseEntropy.toFixed(1)} бит, эффективная: ${analysis.entropy.toFixed(1)} бит. Паттерны значительно ослабляют пароль.`
              : `Base entropy: ${analysis.baseEntropy.toFixed(1)} bits, effective: ${analysis.entropy.toFixed(1)} bits. Patterns significantly weaken the password.`
          });
        }
      }
      ...
      if (analysis.crackTime) {
        if (analysis.crackTime.offlineFast < 3600) { // Less than 1 hour
          recs.push({
            type: 'urgent',
            text: lang === 'ru' ? 'Уязвим для GPU-брутфорса!' : 'Vulnerable to GPU brute-force!',
            detail: lang === 'ru'
              ? `Время взлома на GPU: ${formatCrackTime(analysis.crackTime.offlineFast)}. Это недопустимо для важных аккаунтов.`
              : `GPU crack time: ${formatCrackTime(analysis.crackTime.offlineFast)}. Unacceptable for important accounts.`
          });
        } else if (analysis.crackTime.offlineFast < 86400 * 30) { // Less than 30 days
          recs.push({
            type: 'warn',
            text: lang === 'ru' ? 'Умеренная устойчивость к офлайн-атакам' : 'Moderate resistance to offline attacks',
            detail: lang === 'ru'
              ? `GPU взлом: ${formatCrackTime(analysis.crackTime.offlineFast)}. Рассмотрите более длинный пароль.`
              : `GPU crack: ${formatCrackTime(analysis.crackTime.offlineFast)}. Consider a longer password.`
          });
        }
      }
    ...
    function updateAnalysisUI(analysis) {
      ...
      if (score >= 80) {
        ...
        qualityBar.style.background = 'var(--brand)';
      } else if (score >= 40) {
        qualityBar.style.background = 'var(--warn)';
      } else {
      ...
      // Escape user-derived content (rec details may echo password fragments)
      ...
      recommendations.innerHTML = recs.map(r => `
        <div class="pg-recommendation ${r.type}">
          ...
          <span>
            ${escapeHtml(r.text)}
            ${r.detail ? `<small class="pg-recomm-detail">${escapeHtml(r.detail)}</small>` : ''}
          </span>
        </div>
      `).join('');
    }
      ...
      return new Promise((resolve, reject) => {
        ...
        if (typeof GM_xmlhttpRequest === 'function') {
          GM_xmlhttpRequest({
            method: 'GET',
            url,
            headers: { 'User-Agent': 'CASIMIR-PwdGen/2.0', 'Add-Padding': 'true' },
            onload: (response) => {
          ...
          fetch(url, { headers: { 'Add-Padding': 'true' } })
            .then(response => {
    ...
    // Remote bytes are XOR-mixed with local CSPRNG bytes: the result is at least
    // as strong as window.crypto even if the remote API is compromised or MITM'd.
    function mixWithLocalEntropy(remoteBytes) {
      if (!(window.crypto && window.crypto.getRandomValues)) {
        throw new Error('CRITICAL: window.crypto not available for entropy mixing');
      }
      const localBytes = new Uint8Array(remoteBytes.length);
      window.crypto.getRandomValues(localBytes);
      const mixed = new Uint8Array(remoteBytes.length);
      for (let i = 0; i < remoteBytes.length; i++) mixed[i] = remoteBytes[i] ^ localBytes[i];
      return mixed;
    }
    ...
    async function fetchQuantumBytes(count) {
          ...
          GM_xmlhttpRequest({
            ...
            onload(res) {
              try {
                ...
                if (json.success && json.data && json.data.length >= count) resolve(mixWithLocalEntropy(new Uint8Array(json.data)));
      ...
      if (json.success && json.data && json.data.length >= count) return mixWithLocalEntropy(new Uint8Array(json.data));
      ...
      try {
        ...
        if (isQuantumAPI) {
          try {
            ...
            // ANU QRNG free tier allows ~1 request per minute
            quantumCooldownEnd = Date.now() + 60000;
          } catch (_) {
            badge.style.display = 'inline-block';
        ...
        if (cbQuantum.checked && isQuantumAPI) {
          ...
          badge.style.borderColor = 'var(--quantum)';
    ...
    testInput.addEventListener('input', () => {
      ...
      if (testInput.value.trim()) {
        analyzeTestPassword();
        updateStrengthUI(testInput.value.trim());
      } else {
        updateAnalysisUI(null);
        updateStrengthUI(output.value || '');
      }
